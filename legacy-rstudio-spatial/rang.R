...
installation.order <- structure(list(x = c("lattice", "sp", "rgdal"), version = c("0.20-34", 
"1.2-3", "1.2-4"), source = c("cran", "cran", "cran"), handle = c("lattice", 
...
## rang <- 
## structure(list(call = resolve(pkgs = c("sp", "rgdal"), snapshot_date = "2016-11-30"), 
...
##             "POSIXt"), tzone = "UTC"), original = structure(list(
##                 snapshot_date = structure(c(1480464000, 1480464000, 
##                 1480464000, 1480464000, 1480464000, 1480464000, 
##                 1480464000, 1480464000), class = c("POSIXct", 
##                 "POSIXt"), tzone = "UTC"), x = c("rgdal", "rgdal", 
##                 "rgdal", "rgdal", "rgdal", "rgdal", "rgdal", 
##                 "rgdal"), x_version = c("1.2-4", "1.2-4", "1.2-4", 
##                 "1.2-4", "1.2-4", "1.2-4", "1.2-4", "1.2-4"), 
##                 x_pubdate = structure(c(1479216073, 1479216073, 
##                 1479216073, 1479216073, 1479216073, 1479216073, 
##                 1479216073, 1479216073), class = c("POSIXct", 
...
##                 "Imports", "LinkingTo"), y_raw_version = c(">= 2.14.0", 
...
##             -8L)), deps = list(`cran::sp` = structure(list(snapshot_date = structure(c(1480464000, 
##             1480464000, 1480464000, 1480464000, 1480464000, 1480464000, 
##             1480464000, 1480464000, 1480464000, 1480464000, 1480464000, 
##             1480464000, 1480464000, 1480464000), class = c("POSIXct", 
##             "POSIXt"), tzone = "UTC"), x = c("sp", "sp", "sp", 
##             "sp", "sp", "sp", "sp", "sp", "sp", "sp", "sp", "sp", 
##             "sp", "sp"), x_version = c("1.2-3", "1.2-3", "1.2-3", 
##             "1.2-3", "1.2-3", "1.2-3", "1.2-3", "1.2-3", "1.2-3", 
##             "1.2-3", "1.2-3", "1.2-3", "1.2-3", "1.2-3"), x_pubdate = structure(c(1460631561, 
##             1460631561, 1460631561, 1460631561, 1460631561, 1460631561, 
##             1460631561, 1460631561, 1460631561, 1460631561, 1460631561, 
##             1460631561, 1460631561, 1460631561), class = c("POSIXct", 
##             "POSIXt"), tzone = "UTC"), x_pkgref = c("cran::sp", 
...
##             "cran::RColorBrewer", "cran::rgdal", "cran::rgeos", 
##             "cran::gstat", "cran::maptools", "cran::deldir")), class = "data.frame", row.names = c(NA, 
##             -14L)), `cran::lattice` = structure(list(snapshot_date = structure(c(1480464000, 
##             1480464000, 1480464000, 1480464000, 1480464000, 1480464000, 
##             1480464000, 1480464000, 1480464000), class = c("POSIXct", 
##             "POSIXt"), tzone = "UTC"), x = c("lattice", "lattice", 
##             "lattice", "lattice", "lattice", "lattice", "lattice", 
##             "lattice", "lattice"), x_version = c("0.20-34", "0.20-34", 
##             "0.20-34", "0.20-34", "0.20-34", "0.20-34", "0.20-34", 
##             "0.20-34", "0.20-34"), x_pubdate = structure(c(1473171203, 
##             1473171203, 1473171203, 1473171203, 1473171203, 1473171203, 
##             1473171203, 1473171203, 1473171203), class = c("POSIXct", 
